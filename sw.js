const CACHE='bovitrack-v3-target-lock-v2';
const FILES=['./','./index.html','./manifest.webmanifest','./bovitrack-logo.png','./bovitrack-bg.jpg','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
